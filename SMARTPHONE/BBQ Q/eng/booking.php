...
<div class="container">
	<div class="background">
		<div class="head_bar">
			<table>
				<tr>
					...
					<td style="font-size: 20px;"><center style="margin-bottom: 5px; color: #FFFFFF;">Booking</center></td>
				</tr>
			</table>
		</div><!--end head_bar-->
		<div class="field">
		...
		<a href="file:///C:/xampp/htdocs/test/test/SMARTPHONE/BBQ%20Q/eng/information.php">
			<div class="reserve_btn">Reserve</div>
		</a>
	</div><!--end background-->
</div><!--end container-->
</body>
