		...
		<div class="head_bar">
			<table>
				<tr>
					...
					<td style="font-size: 20px;"><center style="margin-bottom: 5px; color: #FFFFFF;">Discount 10%</center></td>
				</tr>
			</table>
		</div><!--end head_bar-->
		<div class="field">
			<div class="coupon">
				<img src="C:\xampp\htdocs\test\test\SMARTPHONE\BBQ Q\img\dis10.png" style="width: 255px; height: 150px;">
			</div>
			<div class="code">
				<center>
			...
			<a href="file:///C:/xampp/htdocs/test/test/SMARTPHONE/BBQ%20Q/eng/use_dis10.php">
