...
<html>
<head>
	<title>BBQ Q | Discount 100 Baht</title>
</head>
	<style>
		body {
			font-family: arial;
	...
	<div class="background">
		<div class="head_bar">
			<table>
				<tr>
					<td>
						<a href="file:///C:/xampp/htdocs/test/test/SMARTPHONE/BBQ%20Q/eng/coupon.php">
					...
					<td style="font-size: 20px;"><center style="margin-bottom: 5px; color: #FFFFFF;">Discount 100 Baht</center></td>
				</tr>
			</table>
		</div><!--end head_bar-->
		<div class="field">
			<div class="coupon">
				<img src="http://www.visa.com/images/merchantoffers/2016-05/1464167645216.th16_tmb_Tops_Supermarket.jpg" style="width: 255px; height: 150px;">
			</div>
			<div class="code">
				<center>
			...
			<a href="file:///C:/xampp/htdocs/test/test/SMARTPHONE/BBQ%20Q/eng/use_dis100.php">
				<div class="use_btn">Use</div>
			</a>
		</div><!--end field-->
	</div><!--end background-->
</div><!--end container-->
