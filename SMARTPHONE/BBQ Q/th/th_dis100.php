...
<html>
<head>
	<title>BBQ Q | ส่วนลด 100 บาท</title>
</head>
	<style>
		body {
			font-family: arial;
		...
		<div class="head_bar">
			<table>
				<tr>
					...
					<td style="font-size: 20px;"><center style="margin-bottom: 5px; color: #FFFFFF;">ส่วนลด 100 บาท</center></td>
				</tr>
			</table>
		</div><!--end head_bar-->
		<div class="field">
			<div class="coupon">
				<img src="C:\xampp\htdocs\test\test\SMARTPHONE\BBQ Q\img\th_dis100.png" style="width: 255px; height: 150px;">
			</div>
			<div class="code">
				<center>
			...
			<a href="file:///C:/xampp/htdocs/test/test/SMARTPHONE/BBQ%20Q/th/th_use_dis100.php">
