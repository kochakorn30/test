		...
		<div class="head_bar">
			<table>
				<tr>
					...
					<td style="font-size: 20px;"><center style="margin-bottom: 5px;">Shinichi Kudo</center></td>
				</tr>
			</table>
		</div><!--end head_bar-->
		<div class="field">
			<center>
				<img src="http://www.detectiveconanworld.com/wiki/images/f/f9/Shinichi_Kudo_60px.jpg" style="width: 100px; height: 100px; border-radius: 5px;">
			</center>
		</div><!--end field-->
		<div class="japan">Shinichi Kudo</div>
		<div class="eng">Jimmy Kudo</div>
		<div class="detail">Main character of the series and Ran's love interest. He was shrunk into a child after being forced to take a poison, called APTX 4869, created by the Black Organization.</div>
	</div><!--end background-->
</div><!--end container-->
</body>
</html>