...
<div class="container">
	<div class="background">
		<div class="head_bar">
			<table>
				<tr>
					...
					<td style="font-size: 20px;"><center style="margin-bottom: 5px;">อาหารเดลิเวอรี่</center></td>
				</tr>
			</table>
		</div><!--end head_bar-->
		<div class="field">
		...
		<div class="arrow">
			<a href="file:///C:/xampp/htdocs/test/test/SMARTPHONE/EMERGENCY/tab_6.1.php">
