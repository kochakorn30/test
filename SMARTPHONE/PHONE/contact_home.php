...
<div class="container">
	<div class="background">
		<div class="head_bar">
			<table>
				<tr>
					...
					<td style="font-size: 20px;"><center style="margin-bottom: 5px;">Home</center></td>
				</tr>
			</table>
		</div><!--end head_bar-->
		<div class="image">
			<div class="pic">
				<center>
					<img src="C:\xampp\htdocs\test\test\SMARTPHONE\PHONE\img\home.jpg" style="width: 120px; height: 120px; border-radius: 60px; margin-top: 40px;">
				</center>
			</div><!--end image-->
		</div>
		<div class="detail">
		...
		<div class="call">
			<div class="calling">
				<a href="file:///C:/xampp/htdocs/test/test/SMARTPHONE/PHONE/call_home.php">
					<center>
